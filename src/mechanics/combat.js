...
export const processAutoHuntTick = (state) => {
    try {
        ...
        const attackIntervalMs = Math.max(700, _computeAttackIntervalMs(hasteEndTime, bravePotionEndTime, state.characterClass === 'elf', now) - (stats.accuracySpeedBonus || 0) * 25);
